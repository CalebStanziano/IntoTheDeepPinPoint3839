...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = "em0";
        FollowerConstants.leftRearMotorName = "em2";
        FollowerConstants.rightFrontMotorName = "m0";
        FollowerConstants.rightRearMotorName = "m2";
        ...
        FollowerConstants.xMovement = 54.75434120463653;
        FollowerConstants.yMovement = 42.48106881595321;

        FollowerConstants.forwardZeroPowerAcceleration = -35.216234103737364;
        FollowerConstants.lateralZeroPowerAcceleration = -70.99615146536729;

        FollowerConstants.translationalPIDFCoefficients = new CustomPIDFCoefficients(0.07,0,0.0001,0);
